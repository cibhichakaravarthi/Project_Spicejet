...
public class BaseClass {
    ...
    public void launchBrowser(String browser) {
        if (browser.equalsIgnoreCase("Chrome")) {
            System.setProperty("webdriver.chrome.driver", "C:\\Users\\cibhi\\eclipse-workspace\\Ecommerce\\chromedriver\\chromedriver.exe");
            ChromeOptions chromeOp = new ChromeOptions();
            chromeOp.addArguments("--headless=new");
            driver = new ChromeDriver();
            driver.manage().window().maximize();
        } else if (browser.equalsIgnoreCase("Edge")) {
            System.setProperty("webdriver.edge.driver", "C:\\Users\\cibhi\\eclipse-workspace\\Ecommerce\\edgedriver\\msedgedriver.exe");
    ...
    public static void explicitlyWait(int value, WebElement visibilityOfAllElement) {
    ...
    public static void explicitlyWaitAll(int value, WebElement visibilityOfElement) {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(value));
    ...
    public static String takeScreenShot(String testCaseName) {
        ...
        File destinationFile = new File("C:\\Users\\cibhi\\eclipse-workspace\\Project_SpiceJet\\screenshots\\" + testCaseName + ".png");
        try {
